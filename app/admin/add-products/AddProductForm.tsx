  ...
  return (
    <>
      ...
      <CustomCheckBox
        id="inStock"
        register={register}
        label="Este producto está disponible"
      />
      ...
      <div className="w-full flex flex-col flex-wrap gap-4">
        <div>
          ...
          Debe cargar una imagen para cada uno de los colores seleccionados, de lo contrario se ignorará su selección de color.
          </ul>
        </div>
